...
function About() {
  return (
    <div className='relative '>
      <div>
        <div className='relative border-2 border-[#6C63FF] m-7 flex flex-col items-start '>
            <h1 className='text-left absolute  text-[#6C63FF] pt-5 text-5xl font-bold text-center'>
                About Us
            </h1>
            ...
            <button className='bg-[#6C63FF] text-white border border-[#6C63FF] px-7 py-3'>LEARN MORE</button>
        </div>
        </div>
