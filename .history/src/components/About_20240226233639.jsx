    ...
    <div className='relative '>
      <div>
        <div className='relative border-2 border-[#6C63FF] m-7 flex flex-col items-center '>
            ...
            <p className='md:w-1/2 lg:w-1/4 mt-20 text-xl p-5'>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Tenetur voluptatem modi dolore sunt praesentium aut deleniti quia suscipit laboriosam iure reiciendis architecto expedita tempore ipsam officiis, doloremque at repellendus ducimus.</p>    
