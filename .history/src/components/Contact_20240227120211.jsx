        ...
        <div className='my-10 lg:flex justify-center items-center'>
            ...
            <form className='flex flex-col items-center relative text-2xl space-y-5 text-white lg:w-full '>
                <div className='realtive border-4 border-[#6C63FF] rounded-2xl'>
                    <input type="text" placeholder='Name' className='placeholder:pl-3 pl-7 pr-10 lg:pl-14 lg:pr-20 py-3 outline-none bg-[#6C63FF] placeholder:text-white' />
                ...
                <div className='realtive border-4 rounded-2xl border-[#6C63FF]'>
                    <input type="email" placeholder='Email' className='placeholder:pl-3 pl-7 pr-10 lg:pl-14 lg:pr-20 py-3 outline-none bg-[#6C63FF] placeholder:text-white' />
                    <MdOutlineEmail className='absolute text-4xl lg:text-5xl top-[29%] lg:top-[30%] pl-3' />
                </div>
                <div className='border-4 rounded-2xl border-[#6C63FF]'>
                    <input type="text" className='pl-7 pr-10 lg:pl-14 lg:pr-20 py-3 outline-none bg-[#6C63FF] placeholder:pl-3 placeholder:text-white' placeholder='Message' />
                    <LuMessagesSquare className='absolute text-4xl lg:text-5xl top-[53%] lg:top-[56%] pl-3 '  />
                </div>
                <button type='submit' className='border-2 border-[#6C63FF] bg-[#6C63FF] px-14 lg:px-28 py-3 rounded-full 
