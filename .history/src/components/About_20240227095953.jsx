  ...
  return (
    <div className='relative '>
      <div className='lg:flex'>
        ...
        <div>
          <p className='absolute lg:top-[45%] lg:w-1/2 text-left p-3 text-2'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Placeat, consequatur! Illum consectetur dolores culpa sit tempora, inventore veniam obcaecati ab, maiores, rerum deleniti! Laudantium nostrum quas eveniet ipsa rem ad.
