    ...
    <div className='relative '>
      <div className='lg:flex'>
        ...
        <div className=''>
          ...
          <div className='absolute lg:top-[100%] cursor-pointer top-[310%] p-6 flex justify-center items-center space-x-3 lg:left-[50%] text-3xl lg:p-2'>
            <a href=""></a><FaInstagram />
            <FaFacebook />
            <FaXTwitter />
          </div>
        </div>
