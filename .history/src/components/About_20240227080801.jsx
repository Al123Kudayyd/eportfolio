  ...
  return (
    <div className='relative '>
      <div className='relative border-2 border-[#6C63FF] m-5'>
        ...
        para={<div>Lorem, ipsum dolor sit amet consectetur adipisicing elit.<br /> Pariatur nulla odio autem dicta libero quas incidunt<br /> aperiam delectus tempore! Magni cumque autem delectus porro molestiae natus <br />quod, laborum itaque at!</div>} />
        </div>
