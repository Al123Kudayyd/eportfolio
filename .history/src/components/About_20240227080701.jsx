    ...
    <div className='relative '>
      <div className='relative border-2 border-[#6C63FF] m-5'>
        <div className='pl-10 flex flex-col'>
            <h1 className='text-center text-[#6C63FF] pt-5 text-6xl font-bold '>
                About Us
            </h1>
        ...
        para={<div>Lorem, ipsum dolor sit amet consectetur adipisicing elit.<br /> Pariatur nulla odio autem dicta libero quas incidunt aperiam delectus <br />tempore! Magni cumque autem delectus porro molestiae natus <br />quod, laborum itaque at!</div>} />
        </div>
