        ...
        <div className='my-10'>
            <form className='flex flex-col items-center relative text-2xl space-y-5'>
                <div className='realtive border-2'>
                    ...
                    <IoPersonOutline className='absolute top-[5%] text-4xl pl-3' />
                </div>
                <div className='realtive border-2'>
                    <input type="email" placeholder='Email' className='pl-14 pr-20 py-3' />
                    <MdOutlineEmail className='absolute text-4xl top-[34%] pl-3' />
                </div>
                <div className='border-2 '>
                    <input type="text" className='pl-14 pr-20 py-3' placeholder='Message' />
                    <LuMessagesSquare className='absolute text-4xl top-[62%] pl-3' />
                </div>
