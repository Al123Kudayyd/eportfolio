...
function AboutService({ button, button1, button2, para }) {
  return (
    <div className='p-24 flex just'>
        <div className='md:flex justify-center items-center lg:space-x-10 space-y-10 '>
            <div className='flex flex-col items-center lg:w-screen w-10/12'>
