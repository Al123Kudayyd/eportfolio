        ...
        <div className='my-10'>
            <form className='flex flex-col items-center relative text-2xl space-y-5'>
                <div className='realtive border-2'>
                    <input type="text" placeholder='Name' className='pl-12 pr-20 py-3' />
                    <IoPersonOutline className='absolute top-[5%] text-4xl' />
                </div>
                <div className='realtive border-2'>
                    <input type="email" placeholder='Email' className='pl-12 pr-20 py-3' />
                    <MdOutlineEmail className='absolute text-4xl top-[30%]' />
                </div>
