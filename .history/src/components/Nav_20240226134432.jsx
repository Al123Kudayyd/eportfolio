    ...
    <div className=' border-y-2 border-black '>
        <div className='flex justify-between'>
            ...
            <ul className='italic flex justify-center items-center space-x-10 cursor-pointer mx-5 text-md'>
                <li className='hover:text-gray-500 trans '>Home</li>
                <li className='hover:text-gray-500 trans'>Services</li>
                <li className='hover:text-gray-500 trans'>Portfolio</li>
                <li className='hover:text-gray-500 trans'>About</li>
