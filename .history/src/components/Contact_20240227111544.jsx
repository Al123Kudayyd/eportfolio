        ...
        <div className='my-10'>
            <form className='flex flex-col items-center relative text-2xl space-y-5'>
                ...
                <div className='realtive border-2'>
                    ...
                    <MdOutlineEmail className='absolute text-4xl top-[34%]' />
                </div>
                <div className='border-2 '>
                    <input type="text" className='pl-14 pr-20 py-3' placeholder='Message' />
                    <LuMessagesSquare className='absolute text-4xl top-[34%]' />
                </div>
                <input type="text" className='border-2 pl-14 pr-20 py-3' placeholder='Message' />
