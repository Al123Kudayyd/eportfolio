    ...
    <div className='my-24'>
        ...
        <div className='my-10'>
            <form className='flex flex-col items-center relative text-2xl space-y-5'>
                <div className='realtive border-4 rounded-2xl'>
                    <input type="text" placeholder='Name' className='pl-14 pr-20 py-3 bg-[#6C63FF]' />
                    <IoPersonOutline className='absolute top-[2%] text-5xl pl-3' />
                </div>
                <div className='realtive border-4 rounded-2xl'>
                    <input type="email" placeholder='Email' className='pl-14 pr-20 py-3 bg-[#6C63FF]' />
                ...
                <div className='border-4 rounded-2xl '>
                    ...
                    <LuMessagesSquare className='absolute text-5xl top-[62%] pl-3 bg-[#6C63FF]' />
                </div>
