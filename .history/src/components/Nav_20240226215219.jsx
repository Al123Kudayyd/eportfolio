  ...
  return (
    <div className=' border-y-2 border-black '>
        <div className='flex justify-between'>
            <h1 className='font-bold py-10 pl-20 lg:text-6xl text-2xl border-r-4 pr-14 border-black bg-gradient-to-r from-orange-300 via-purple-400 to-blue-300'>BLYNK</h1>
