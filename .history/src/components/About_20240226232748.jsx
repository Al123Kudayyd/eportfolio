...
function About() {
  return (
    <div className='relative '>
      <div>
        <div className='relative border-2 border-[#6C63FF] m-7 max-w-[1400px] left-[0]'>
            <h1 className='text-left absolute  text-[#6C63FF] left pt-5 text-5xl font-bold'>
                About Us
            </h1>
        ...
        <img src={about} className='absolute -top-28 w-[40%] lg:w-[30%] shadow-2xl right-4' />
    </div>
  )
}
