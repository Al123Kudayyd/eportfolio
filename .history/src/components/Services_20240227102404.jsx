  ...
  return (
    <div className=''>
      ...
      <div className='relative'>
        <img src={service} className='w-1/2 lg:w-1/4 translate-x-[150%]' alt="" />
        <h1 className='text-4xl'>Your service</h1>
        <p className='text-md'>Add the service you will be providing!</p>
      </div>
      <div>
        <img src={service1} className='w-1/2 lg:w-1/4 translate-x-[150%]' alt="" />
        <h3 className='text-4xl'>Your Serivce</h3>
        <p className='text-md'>Add the service you will be providing!</p>
      </div>
      <div>
        <img src={service2} className='w-1/2 lg:w-1/4translate-x-[150%]' alt="" />
        <h3 className='text-4xl'>Your Serivce</h3>
        <p className='text-md'>Add the service you will be providing!</p>
      </div>
      </Slider>
