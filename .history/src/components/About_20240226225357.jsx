  ...
  return (
    <div className=''>
        <div className='relative border-2 border-[#6C63FF] m-7'>
            ...
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit.<br /> Labore, sunt eum in ipsam aperiam, ipsa praesentium sit nobis facere sapiente expedita voluptate ipsum impedit quam ea quos amet debitis culpa.</p>
