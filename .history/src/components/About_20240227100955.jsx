    ...
    <div className='relative '>
      <div className='lg:flex'>
        ...
        <div className='flex flex-col justify-center'>
          <p className='absolute lg:top-[35%] lg:w-1/2 text-left p-6 lg:p-4 text-xl'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Placeat, consequatur! Illum consectetur dolores culpa sit tempora, inventore veniam obcaecati ab, maiores, rerum deleniti! Laudantium nostrum quas eveniet ipsa rem ad.
