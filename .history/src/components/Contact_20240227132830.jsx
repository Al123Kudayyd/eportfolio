        ...
        <div className='my-10 lg:flex justify-center items-center'>
            ...
            <form className='flex flex-col items-center relative text-2xl space-y-5 text-white lg:w-full '>
                ...
                <div className='realtive border-4 rounded-2xl border-[#6C63FF]'>
                    <input type="email" placeholder='Email' className='placeholder:pl-6 pl-7 pr-10 lg:pl-14 lg:pr-20 py-3 outline-none bg-[#6C63FF] placeholder:text-white' />
                ...
                <div className='border-4 rounded-2xl border-[#6C63FF]'>
                    <input type="text" className='pl-7 pr-10 lg:pl-14 lg:pr-20 py-3 outline-none bg-[#6C63FF] placeholder:pl-6 placeholder:text-white' placeholder='Message' />
