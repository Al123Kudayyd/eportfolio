        ...
        <div className='my-10'>
            <form className='flex flex-col items-center relative text-2xl space-y-5'>
                <div className='realtive border-2'>
                    <input type="text" placeholder='Name' className='p-8' />
                    <IoPersonOutline className='absolute top-[2%]' />
                </div>
                <div className='realtive border-2'>
                    <input type="email" placeholder='Email' className='p-8' />
                    <MdOutlineEmail className='absolute top-[30%]' />
                </div>
                <input type="text" className='border-2 px-8' placeholder='Message' />
