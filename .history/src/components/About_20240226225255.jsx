  ...
  return (
    <div className='relative'>
        <div className='relative border-2 border-[#6C63FF] m-7'>
            ...
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Labore, sunt eum in ipsam aperiam, ipsa praesentium sit nobis facere sapiente expedita voluptate ipsum impedit quam ea quos amet debitis culpa.</p>
