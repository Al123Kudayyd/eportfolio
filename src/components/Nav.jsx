  ...
  return (
    <div className=' border-y-2 border-black sticky top-0 z-10'>
        <div className='flex justify-between'>
            <h1 className='font-bold py-10 pl-16 lg:text-6xl text-4xl border-r-4 pr-14 border-black bg-gradient-to-r from-orange-300 via-purple-400 to-blue-300'>YOURS</h1>
